...
export type Variant = "solid" | "outline" | "dashed" | "ghost";
...
const variantColorClasses: Record<Variant, Record<TextColor, string>> = {
  solid: {
...
export const NavLink = ({
  ...
  return (
    <Link
      href={href}
      {...props}
      className={`block ${textSizes[size]} ${borderRadius[radius]} ${variantColorClasses[variant][color]} transition-all ${className}`}
    >
      {children}
    </Link>
  );
